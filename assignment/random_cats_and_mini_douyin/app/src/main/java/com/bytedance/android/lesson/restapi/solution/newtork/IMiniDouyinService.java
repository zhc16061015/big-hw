...
public interface IMiniDouyinService {
    ...
    Call<PostVideoResponse> request(@Part() MultipartBody.Part cover_image,@Part() MultipartBody.Part video, @Query("student_id")String student_id,@Query("user_name") String user_name);
